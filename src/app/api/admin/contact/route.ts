  ...
  try {
    ...
    if (!contact) {
      ...
      contact = await ContactInfo.create({
        ...
        socialLinks: {
          facebook: "https://facebook.com/reckronsp",
          linkedin: "https://linkedin.com/company/reckronsp",
          twitter: "https://twitter.com/reckronsp",
          youtube: "https://youtube.com/reckronsp",
          instagram: "https://instagram.com/reckronsp",
        },
      });
    }
